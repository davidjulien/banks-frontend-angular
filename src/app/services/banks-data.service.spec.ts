...
import { TransactionsPage } from '../models/transactions-page.model';
...
const TRANSACTIONS_DATA_EXPECTED = new TransactionsPage(
  [
    new Transaction(1, new Bank("ing", "ING"), "CLIENT", "ACCOUNT", new Date(Date.UTC(2020,8,24,12,0,0)), "TRANSACTION", new Date(Date.UTC(2020,8,24)), new Date(Date.UTC(2020,8,24)), -123.45, "PAIEMENT PAR CARTE", TransactionType.SEPA_DEBIT)
  ]);
